...
# ---------------------------------------------------------------------------- #
def plot_stereo_hgt(dataarray, save=False, name_fig='stereo_plot', out_dir='/'):
    fig, ax = plt.subplots(
    ...
    levels = [-75, -50, -35, -20, -10, -5, 0, 5, 10, 20, 30, 50, 75]

    cf = ax.contourf(lons, lats, field, transform=ccrs.PlateCarree(),
    ...
    ax.gridlines(draw_labels=True, crs=ccrs.PlateCarree(), lw=0.3, color="gray",
                 xlocs=range(-180, 180, 30), ylocs=np.arange(-80, -20, 20))
